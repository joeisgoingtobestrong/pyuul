...
test_label=pd.read_csv('/lustre/home/acct-clschf/clschf/yxjiang/trajin/pyuul/activ_test.csv',header=None)
...
#device = "cpu" 
test_coords, test_atname = utils.parsePDB("/lustre/home/acct-clschf/clschf/yxjiang/trajin/pyuul/pyuul2/") #一次读取所有的结构
...
train_data=MyDataset(txt_path='/lustre/home/acct-clschf/clschf/yxjiang/trajin/pyuul/413/activ841.txt')
